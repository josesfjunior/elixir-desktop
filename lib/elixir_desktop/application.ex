defmodule ElixirDesktop.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      ElixirDesktop.Repo,
      {DNSCluster, query: Application.get_env(:elixir_desktop, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: ElixirDesktop.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: ElixirDesktop.Finch},
  ...
  def config_change(changed, _new, removed) do
    ElixirDesktopWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
